...
func (c *greetServiceClient) SayHelloBiDirectional(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloBiDirectionalClient = grpc.BidiStreamingClient[HelloRequest, HelloResponse]
...
func (UnimplementedGreetServiceServer) SayHelloBiDirectional(grpc.BidiStreamingServer[HelloRequest, HelloResponse]) error {
	return status.Error(codes.Unimplemented, "method SayHelloBiDirectional not implemented")
}
...
func _GreetService_SayHelloBiDirectional_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBiDirectional(&grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloBiDirectionalServer = grpc.BidiStreamingServer[HelloRequest, HelloResponse]
