...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\bmessages\x18\x01 \x03(\tR\bmessages2\xd3\x02\n" +
	"\fgreetService\x12@\n" +
	...
	"\x17sayHelloClientStreaming\x12\x1b.greet_service.HelloRequest\x1a\x1a.greet_service.MessageList(\x01\x12V\n" +
	"\x15SayHelloBiDirectional\x12\x1b.greet_service.HelloRequest\x1a\x1c.greet_service.HelloResponse(\x010\x01B\tZ\a./protob\x06proto3"
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	2, // 3: greet_service.greetService.SayHelloBiDirectional:input_type -> greet_service.HelloRequest
